...
st.subheader("Number of Actors per Movie")

# Generate and display actor count distribution
actor_count_df = movie_data.actor_count()
st.bar_chart(actor_count_df.set_index("Number_of_Actors"),x_label="Number of Actors",y_label="Movie Count")
...
min_height = st.sidebar.number_input("Minimum Height (cm)", min_value=50.0, max_value=250.0, value=150.0)
max_height = st.sidebar.number_input("Maximum Height (cm)", min_value=50.0, max_value=250.0, value=200.0)
